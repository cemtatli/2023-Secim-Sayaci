...
const style = {
  container: `flex lg:flex-row flex-wrap items-center justify-center w-full gap-4 my-10 select-none`,
  body: `flex flex-col items-center justify-center w-32 h-32 lg:w-60 lg:h-60 text-2xl font-bold rounded-lg text-white bg-gradient-to-r from-red-300 to-red-400 dark:bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] dark:from-blue-700 dark:via-blue-800 dark:to-gray-900 dark:text-white `,
